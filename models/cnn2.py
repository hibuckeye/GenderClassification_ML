...
def simple_CNN2(input_shape, num_classes):
    model = Sequential()
    model.add(Convolution2D(filters=16, kernel_size=(7, 7), padding='same',
                            name='image_array', input_shape=input_shape))
    model.add(BatchNormalization())
...
def simple_CNN3(input_shape, num_classes):
    model = Sequential()
    model.add(Convolution2D(filters=16, kernel_size=(7, 7), padding='same',
                            name='image_array', input_shape=input_shape))
    model.add(BatchNormalization())
...
def simple_XCEPTION(input_image, num_classes):

    # base
    img_input = Input(input_image)
    ...
    # output
    x = Conv2D(num_classes, (3, 3), padding='same', use_bias=False)(x)
...
def simple_XCEPTION2(input_image, num_classes):
...
def simple_XCEPTION3(input_image, num_classes):
...
def simple_XCEPTION4(input_image, num_classes):
