...
class DataManager(object):
    ...
    def __init__(self, dataset_name='LFW', dataset_path=None, image_size=(250, 250)):
        ...
        if self.dataset_path != None:
            ...
            self.dataset_path = '../datasets/LFW/LFW.mat'
    ...
    def get_data(self):
        if self.dataset_name =='LFW':
            ground_truth_data = self._load_LFW()
        elif self.dataset_name == 'imdb':
    ...
    def _load_LFW(self):
        ...
        image_names_array = dataset['LFW']['full_path'][0, 0][0]
        gender_classes = dataset['LFW']['gender'][0, 0][0]
        gender_classes = gender_classes.tolist()
        image_names = []
...
def split_face_data(ground_truth_data, validation_split=.2, do_shuffle=False):
